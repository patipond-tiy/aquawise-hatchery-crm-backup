    ...
    Tables: {
      ...
      batch_claims: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "batch_claims_nursery_id_fkey";
            columns: ["nursery_id"];
            isOneToOne: false;
            referencedRelation: "nurseries";
            referencedColumns: ["id"];
      ...
      batches: {
        Row: {
          ...
          nursery_contact_snapshot: Json | null;
          nursery_id: string;
      ...
      crm_event_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "crm_event_log_batch_id_fkey";
            columns: ["batch_id"];
            isOneToOne: false;
            referencedRelation: "batches";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "crm_event_log_nursery_id_fkey";
            columns: ["nursery_id"];
            isOneToOne: false;
            referencedRelation: "nurseries";
            referencedColumns: ["id"];
