...
create table public.team_invites (
  ...
  role        public.nursery_role not null,
...
create index team_invites_nursery_idx on public.team_invites(nursery_id);
create index team_invites_token_idx    on public.team_invites(token);

alter table public.team_invites enable row level security;

-- Owner-only: all operations scoped to their nursery.
